...
#if defined ( CC2540_MINIDK )
    /* Rising/Falling edge configuratinn */
    PICTL |= HAL_KEY_SW_1_EDGEBIT;   /* Set P0.(0-7) to falling edge on input gives interrupt */
...
#if defined ( CC2540_MINIDK )
  if ((HAL_KEY_SW_3_PXIFG & HAL_KEY_SW_3_BIT) || (HAL_KEY_SW_4_PXIFG & HAL_KEY_SW_4_BIT) || (HAL_KEY_SW_6_PXIFG & HAL_KEY_SW_6_BIT))
#else
  if (HAL_KEY_SW_6_PXIFG & HAL_KEY_SW_6_BIT)
#endif
  {
