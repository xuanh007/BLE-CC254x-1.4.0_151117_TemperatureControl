...
// ADC voltage levels
#define BATT_ADC_LEVEL_3V           768
#define BATT_ADC_LEVEL_LOW           621
#define BATT_ADC_LEVEL_2V           585
...
static uint8 battServiceAdcCh = HAL_ADC_CHANNEL_4;
...
bStatus_t Batt_MeasLevel_ext(uint8 level)
{
    // Update level
    battLevel = level;
