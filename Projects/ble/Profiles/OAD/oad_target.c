...
static bStatus_t oadImgIdentifyWrite( uint16 connHandle, uint8 *pValue )
{
  ...
  //SerialPrintValue("<in IdfyW>rxHdr.ver = ", rxHdr.ver, 10);
  //SerialPrintString("\n");
  //SerialPrintValue("<in IdfyW>rxHdr.len = ", rxHdr.len, 10);
  //SerialPrintString("\n");
  ...
  //SerialPrintValue("<in IdfyW>oadBlkTot = ", oadBlkTot, 10);
  //SerialPrintString("\n");
  ...
  else
  {
    ...
    //SerialPrintValue("<in IdfyW>connHandle = ", connHandle, 10);
    //SerialPrintString("\n");
  }
...
static void oadImgIdentifyReq(uint16 connHandle, img_hdr_t *pImgHdr)
{
  //SerialPrintString("in IdfyReq"); 
  //SerialPrintString("\n"); 
  uint16 value = GATTServApp_ReadCharCfg( connHandle, oadImgIdentifyConfig );
  //SerialPrintValue("<in IdfyReq>value = ", value, 10);
  //SerialPrintString("\n"); 
  // If notifications enabled
  if ( value & GATT_CLIENT_CFG_NOTIFY )
  {
    //SerialPrintString("if notifications enabled");
    //SerialPrintString("\n");     
    attHandleValueNoti_t noti;
    gattAttribute_t *pAttr = GATTServApp_FindAttr(oadAttrTbl, GATT_NUM_ATTRS(oadAttrTbl),
    ...
    /*SerialPrintValue("<in IdfyReq>noti.value[0] = ", noti.value[0], 10);
    SerialPrintString("\n"); 
    
    SerialPrintValue("<in IdfyReq>noti.value[1] = ", noti.value[1], 10);
    SerialPrintString("\n"); 
    
    SerialPrintValue("<in IdfyReq>noti.value[2] = ", noti.value[2], 10);
    SerialPrintString("\n"); 
    
    SerialPrintValue("<in IdfyReq>noti.value[3] = ", noti.value[3], 10);
    SerialPrintString("\n");   */  
    ...
    //SerialPrintValue("<in IdfyReq> End ");
    //SerialPrintString("\n");    
  }
}
