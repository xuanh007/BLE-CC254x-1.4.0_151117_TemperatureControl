  ...
  if ( events & SBP_PERIODIC_IIC_WRITE_PERMIT_EVT )
  {
      ...
      if(P0_6 == 0)
      {
          ...
          if(g_set_write_flag == 0){
            //for(i=0; i<6; i++){
              Write_Add(0xa0,0x00,0x10,g_rsv_buff[0]);//向器件写一个数据: 
              Write_Add(0xa0,0x00,0x11,g_rsv_buff[1]);
              Write_Add(0xa0,0x00,0x12,g_rsv_buff[2]);
              Write_Add(0xa0,0x00,0x13,g_rsv_buff[3]);
            //}
            ...
            for(i=0; i<168; i++){
              Write_Add(0xa0,0x00,0x30+i,g_rsv_buff[6+i]);//向器件写一个数据: 
            }
            //HalSensorWriteReg(0x10, g_rsv_buff, 6);
            g_set_write_flag++;
            osal_start_timerEx( simpleBLEPeripheral_TaskID, SBP_PERIODIC_IIC_WRITE_PERMIT_EVT, 500 );
          }else if(g_set_write_flag == 2){
            for(i=0; i<6; i++){
              Write_Add(0xa0,0x00,0xE0+i,g_rsv_buff[174+i]);//向器件写一个数据: 
            }
            //HalSensorWriteReg(0x10, g_rsv_buff, 6);
            g_set_write_flag++;
            osal_start_timerEx( simpleBLEPeripheral_TaskID, SBP_PERIODIC_IIC_WRITE_PERMIT_EVT, 50 );
            ...
            for(i=0; i<4; i++){
              Write_Add(0xa0,0x00,0xF0+i,g_rsv_buff[180+i]);//向器件写一个数据: 
            }
            //HalSensorWriteReg(0x10, g_rsv_buff, 6);
            g_set_write_flag++;
            osal_start_timerEx( simpleBLEPeripheral_TaskID, SBP_PERIODIC_IIC_WRITE_PERMIT_EVT, 50 );
  ...
  if ( events & SBP_PERIODIC_CONN_READ_EVT )
  {
     ...
     // SerialPrintString("read & notify B1/B2/B2 datas!\t\n!");
      ...
      if(g_con_read_flag == 0){
        Write_Add(0xa0,0x00,0x01+1,0x88);//向器件写一个数据: 
        
        g_con_read_flag++;
        osal_start_timerEx( simpleBLEPeripheral_TaskID, SBP_PERIODIC_CONN_READ_EVT, 50 );
      }else if(g_con_read_flag == 1){
        Write_Add(0xa0,0x00,0x01+g_con_read_flag+1,0x88+g_con_read_flag);//向器件写一个数据: 
        //SerialPrintValue("addr 0x0001 = ", data, 16);
        g_con_read_flag++;
        osal_start_timerEx( simpleBLEPeripheral_TaskID, SBP_PERIODIC_CONN_READ_EVT, 50 );
        ...
        g_con_read_flag++;
        osal_start_timerEx( simpleBLEPeripheral_TaskID, SBP_PERIODIC_CONN_READ_EVT, 50 );
      }else if(g_con_read_flag == 4){
        Write_Add(0xa0,0x00,0x01+g_con_read_flag+1,0x88+g_con_read_flag);//向器件写一个数据: 
        //SerialPrintValue("addr 0x0001 = ", data, 16);
        g_con_read_flag++;
        osal_start_timerEx( simpleBLEPeripheral_TaskID, SBP_PERIODIC_CONN_READ_EVT, 50 );
      }else if(g_con_read_flag == 5){
        Write_Add(0xa0,0x00,0x01+g_con_read_flag+1,0x88+g_con_read_flag);//向器件写一个数据: 
        //SerialPrintValue("addr 0x0001 = ", data, 16);
        g_con_read_flag++;
        osal_start_timerEx( simpleBLEPeripheral_TaskID, SBP_PERIODIC_CONN_READ_EVT, 50 );
      }else if(g_con_read_flag == 6){
        Write_Add(0xa0,0x00,0x01+g_con_read_flag+1,0x88+g_con_read_flag);//向器件写一个数据: 
        //SerialPrintValue("addr 0x0001 = ", data, 16);
        g_con_read_flag++;
        osal_start_timerEx( simpleBLEPeripheral_TaskID, SBP_PERIODIC_CONN_READ_EVT, 50 );
      }else if(g_con_read_flag == 7){
        Write_Add(0xa0,0x00,0x01+g_con_read_flag+1,0x88+g_con_read_flag);//向器件写一个数据: 
        //SerialPrintValue("addr 0x0001 = ", data, 16);
        g_con_read_flag++;
        osal_start_timerEx( simpleBLEPeripheral_TaskID, SBP_PERIODIC_CONN_READ_EVT, 50 );
      }else if(g_con_read_flag == 8){
        Write_Add(0xa0,0x00,0x01+g_con_read_flag+1,0x88+g_con_read_flag);//向器件写一个数据: 
        //SerialPrintValue("addr 0x0001 = ", data, 16);
        g_con_read_flag++;
        osal_start_timerEx( simpleBLEPeripheral_TaskID, SBP_PERIODIC_CONN_READ_EVT, 50 );
      }else if(g_con_read_flag == 9){
        read_y = Read_N_Add(0xa0,0x00,0x01,0xa1);
        //SerialPrintValue("addr 0x0001 = ", data, 16);
        //g_con_read_flag++;
        for(i=0;i<10;i++){
            SerialPrintValue("addr 0x0001 = ", read_y.read[i], 16);
        }
     ...
     /* if(g_con_read_flag == 0){
        for(i=0; i<6; i++){
            g_send_buff[0+i] = Read_Add(0xa0,0x00,0x10+i,0xa1);
        }
        g_con_read_flag++;
        osal_start_timerEx( simpleBLEPeripheral_TaskID, SBP_PERIODIC_CONN_READ_EVT, 50 );
      }else if(g_con_read_flag == 1){
        for(i=0; i<168; i++){
            g_send_buff[6+i] = Read_Add(0xa0,0x00,0x30+i,0xa1);
        }
        g_con_read_flag++;
        osal_start_timerEx( simpleBLEPeripheral_TaskID, SBP_PERIODIC_CONN_READ_EVT, 500 );
      }else if(g_con_read_flag == 2){
        for(i=0; i<6; i++){
            g_send_buff[174+i] = Read_Add(0xa0,0x00,0xE0+i,0xa1);
        }
        g_con_read_flag++;
        osal_start_timerEx( simpleBLEPeripheral_TaskID, SBP_PERIODIC_CONN_READ_EVT, 50 );
      }else if(g_con_read_flag == 3){
        for(i=0; i<4; i++){
            g_send_buff[180+i] = Read_Add(0xa0,0x00,0xF0+i,0xa1);
        }
        g_con_read_flag++;
        osal_start_timerEx( simpleBLEPeripheral_TaskID, SBP_PERIODIC_CONN_READ_EVT, 50 );
      }else{
