...
extern void Write_Add(uchar slave_write_address,uchar byte_High_address,uchar byte_Low_address,uchar data_data);    //向某个IIC器件写指令，地址和数据
extern uchar Read_Add(uchar slave_write_address,uchar byte_High_address,uchar byte_Low_address,uchar slave_read_address);               //向某个IIC器件写指令读某个地址里面的数据
