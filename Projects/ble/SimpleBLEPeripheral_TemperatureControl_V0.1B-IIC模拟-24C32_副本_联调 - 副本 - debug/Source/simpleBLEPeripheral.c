...
void SimpleBLEPeripheral_Init( uint8 task_id )
{
  ...
  osal_start_timerEx( simpleBLEPeripheral_TaskID, SBP_PERIODIC_START_DATA_STORE_EVT, (uint32)60*1000 );
     ...
     // SerialPrintString("SBP_PERIODIC_READ_TO_NOTIYF_EVT!!!!");
          ...
          if(date_flag < date_lens){
              ...
              if(count_flag == 0){
                  ...
                  noti.value[2] = 0xFF & (g_datas_count >> 8);
                  noti.value[3] = 0xFF & (g_datas_count);
                  GATT_Notification(0, &noti, FALSE);
              }
              noti.len = date_lens;
              noti.handle = 0x2E;
